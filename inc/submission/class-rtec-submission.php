...
class RTEC_Submission
{
    ...
    private function get_conf_message()
    {
        ...
        if ( isset( $rtec_options['confirmation_message'] ) ) {
            ...
            $body .= sprintf( __( 'Event' ) .': %1$s at %2$s on %3$s'. "\n",
